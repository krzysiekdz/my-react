wirtualny element to obiekt, ktory posiada wszelkie informacje na podstawie ktorych mozna stworzyc obiekt DOM; obiekt DOM jest duzy, np dwa paragrafy to duze obiekty a moga sie ró¿niæ jedynie tekstem w sobie; obiekt wirtualny paragrafu zawiera³by w takim razie jedynie tekst - dzieki temu jestemy w stanie szybciej sprawdzic czym dane elementy siê ró¿ni¹; 
